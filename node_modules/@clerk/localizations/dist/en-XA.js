...
// src/en-XA.ts
var en_XA_exports = {};
__export(en_XA_exports, {
  enXA: () => enXA
});
module.exports = __toCommonJS(en_XA_exports);
...
function pseudoLocalizeString(value) {
  return value.replace(tokenOrLetterPattern, (segment) => {
    ...
    return (_a = pseudoCharacterMapWithUppercase[segment]) != null ? _a : segment;
  });
}
function pseudoLocalizeValue(value) {
  ...
  if (Array.isArray(value)) {
    return value.map((item) => pseudoLocalizeValue(item));
  }
...
var enXAFromEnUS = pseudoLocalizeValue(enUS);
var enXA = {
  ...enXAFromEnUS,
  locale: "en-XA"
};
